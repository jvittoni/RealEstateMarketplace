  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button disabled={loading} className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-85 cursor-pointer'>
      ...
      <p className='text-green-600'>{updateSuccess ? 'User has been updated successfully!' : ''}</p>
    </div>
  )
}
