        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    <input type="file" id="images" accept='images/*' multiple className='p-3 border border-gray-300 rounded w-full' />
                    <button className='p-3 text-green-700 border border-green-700 roundede uppercase hover:shadow-lg disabled:opacity-80 cursor-pointer'>Upload</button>
                </div>
